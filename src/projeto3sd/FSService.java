...
public class FSService {
  ...
  public interface Iface {
    ...
    public List<TPage> ListFiles(String path) throws org.apache.thrift.TException;

    public boolean AddFile(String path, ByteBuffer data) throws org.apache.thrift.TException;

    public TPage UpdateFile(String path, ByteBuffer data) throws org.apache.thrift.TException;

    public TPage DeleteFile(String path) throws org.apache.thrift.TException;

    public TPage UpdateVersion(String path, ByteBuffer data, int version) throws org.apache.thrift.TException;

    public TPage DeleteVersion(String path, int version) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public List<TPage> recv_ListFiles() throws org.apache.thrift.TException
    {
    ...
    public TPage recv_UpdateFile() throws org.apache.thrift.TException
    {
    ...
    public TPage recv_DeleteFile() throws org.apache.thrift.TException
    {
    ...
    public TPage recv_UpdateVersion() throws org.apache.thrift.TException
    {
    ...
    public TPage recv_DeleteVersion() throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class ListFiles_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public List<TPage> getResult() throws org.apache.thrift.TException {
        if (getState() != org.apache.thrift.async.TAsyncMethodCall.State.RESPONSE_READ) {
          throw new IllegalStateException("Method call not finished!");
        }
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class ListFiles<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, ListFiles_args, List<TPage>> {
      public ListFiles() {
        super("ListFiles");
      }
      ...
      public AsyncMethodCallback<List<TPage>> getResultHandler(final AsyncFrameBuffer fb, final int seqid) {
        final org.apache.thrift.AsyncProcessFunction fcall = this;
        return new AsyncMethodCallback<List<TPage>>() { 
          public void onComplete(List<TPage> o) {
            ListFiles_result result = new ListFiles_result();
            result.success = o;
            try {
              fcall.sendResponse(fb,result, org.apache.thrift.protocol.TMessageType.REPLY,seqid);
      ...
      public void start(I iface, ListFiles_args args, org.apache.thrift.async.AsyncMethodCallback<List<TPage>> resultHandler) throws TException {
    ...
    public static class UpdateFile<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, UpdateFile_args, TPage> {
      public UpdateFile() {
        super("UpdateFile");
      }
      ...
      public void start(I iface, UpdateFile_args args, org.apache.thrift.async.AsyncMethodCallback<TPage> resultHandler) throws TException {
        iface.UpdateFile(args.path, args.data,resultHandler);
      }
    }

    public static class DeleteFile<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, DeleteFile_args, TPage> {
      public DeleteFile() {
        super("DeleteFile");
      }
      ...
      public void start(I iface, DeleteFile_args args, org.apache.thrift.async.AsyncMethodCallback<TPage> resultHandler) throws TException {
        iface.DeleteFile(args.path,resultHandler);
      }
    }

    public static class UpdateVersion<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, UpdateVersion_args, TPage> {
      public UpdateVersion() {
        super("UpdateVersion");
      }
      ...
      public void start(I iface, UpdateVersion_args args, org.apache.thrift.async.AsyncMethodCallback<TPage> resultHandler) throws TException {
        iface.UpdateVersion(args.path, args.data, args.version,resultHandler);
      }
    }

    public static class DeleteVersion<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, DeleteVersion_args, TPage> {
      public DeleteVersion() {
        super("DeleteVersion");
      }
      ...
      public void start(I iface, DeleteVersion_args args, org.apache.thrift.async.AsyncMethodCallback<TPage> resultHandler) throws TException {
  ...
  public static class ListFiles_result implements org.apache.thrift.TBase<ListFiles_result, ListFiles_result._Fields>, java.io.Serializable, Cloneable, Comparable<ListFiles_result>   {
    ...
    public List<TPage> success; // required
    ...
    public ListFiles_result(ListFiles_result other) {
      if (other.isSetSuccess()) {
        List<TPage> __this__success = new ArrayList<TPage>(other.success.size());
        for (TPage other_element : other.success) {
          __this__success.add(new TPage(other_element));
        }
    ...
    public java.util.Iterator<TPage> getSuccessIterator() {
      return (this.success == null) ? null : this.success.iterator();
    }

    public void addToSuccess(TPage elem) {
      if (this.success == null) {
        this.success = new ArrayList<TPage>();
      }
      this.success.add(elem);
    }

    public List<TPage> getSuccess() {
      return this.success;
    }

    public ListFiles_result setSuccess(List<TPage> success) {
      this.success = success;
      return this;
    }
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<TPage>(_list0.size);
                  TPage _elem1;
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, ListFiles_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (TPage _iter3 : struct.success)
            {
              _iter3.write(oprot);
            }
            oprot.writeListEnd();
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (TPage _iter4 : struct.success)
            {
              _iter4.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<TPage>(_list5.size);
            TPage _elem6;
  ...
  public static class UpdateFile_result implements org.apache.thrift.TBase<UpdateFile_result, UpdateFile_result._Fields>, java.io.Serializable, Cloneable, Comparable<UpdateFile_result>   {
    ...
    public UpdateFile_result setSuccess(TPage success) {
      this.success = success;
      return this;
    }
  ...
  public static class DeleteFile_result implements org.apache.thrift.TBase<DeleteFile_result, DeleteFile_result._Fields>, java.io.Serializable, Cloneable, Comparable<DeleteFile_result>   {
    ...
    public DeleteFile_result setSuccess(TPage success) {
      this.success = success;
      return this;
    }
  ...
  public static class UpdateVersion_result implements org.apache.thrift.TBase<UpdateVersion_result, UpdateVersion_result._Fields>, java.io.Serializable, Cloneable, Comparable<UpdateVersion_result>   {
    ...
    public UpdateVersion_result setSuccess(TPage success) {
      this.success = success;
      return this;
    }
  ...
  public static class DeleteVersion_result implements org.apache.thrift.TBase<DeleteVersion_result, DeleteVersion_result._Fields>, java.io.Serializable, Cloneable, Comparable<DeleteVersion_result>   {
    ...
    public DeleteVersion_result setSuccess(TPage success) {
      this.success = success;
      return this;
    }
